...
namespace Ryuk
{
    ...
    public class WageTaxWorkflow2023a : IWageTaxWorkflow
    {
        private readonly ILogger<WageTaxWorkflow2023a> _logger;
        ...
        public WageTaxWorkflow2023a(IInputParameter input, ILogger<WageTaxWorkflow2023a> log)
        {
            InputPara = input;
